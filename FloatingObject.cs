    ...
    public class FloatingObject : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            if (this.calculateDensity)
            {
                ...
                this.Mass = this.rigidbody.mass / objectVolume;
            }
        }
        ...
        protected virtual void FixedUpdate()
        {
            if (this.water != null && this.voxels.Length > 0)
            {
                ...
                for (int i = 0; i < this.voxels.Length; i++)
                {
                    ...
                    Debug.DrawLine(worldPoint, worldPoint + finalVoxelForce.normalized, Color.green);
                }
        ...
        {
            float objectVolume = this.rigidbody.mass  / this.Mass;
